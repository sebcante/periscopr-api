...
class SuggestedPeople extends BaseRequest {

    private $allowed_params = [
        'twitter_consumer' => true,
        'twitter_secret' => true,
    ];
    ...
    */
    public function __construct($params = []) {
        ...
        $this->response = 'Cjhbtn\\Periscopr\\Api\\Responses\\SuggestedPeople';
    }
}